...
export type FetchRepositoriesQueryVariables = Exact<{
  query: Scalars['String'];
}>;
...
export type VueRepositoryQueryVariables = Exact<{ [key: string]: never; }>;


export type VueRepositoryQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'createdAt'>
  )> }
);
...
export const FetchRepositoriesDocument = gql`
  ...
  search(query: $query, type: REPOSITORY, first: 100) {
    ...
    `;
export const VueRepositoryDocument = gql`
    query vueRepository {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchRepositories(variables: FetchRepositoriesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchRepositoriesQuery> {
      return withWrapper(() => client.request<FetchRepositoriesQuery>(print(FetchRepositoriesDocument), variables, requestHeaders));
    },
    vueRepository(variables?: VueRepositoryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<VueRepositoryQuery> {
      return withWrapper(() => client.request<VueRepositoryQuery>(print(VueRepositoryDocument), variables, requestHeaders));
    }
  };
}
